...
class WeatherDetailsScraper {
  ...
  String timau = "/en/hr/lucko/112791/weather-forecast/112791";
  ...
  Future<DetailsPageModel> pageDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      Element? currentWeatherIcon = document.querySelector("a.cur-con-weather-card.is-desktop.lbar-panel.content-module > div.cur-con-weather-card__body > div.cur-con-weather-card__panel > svg");
      ...
      for (Element element in tenDay){
        tenDayForecast.add(
          TenDayForecast(
              ...
              dayIcon: element.querySelector("img.icon")?.attributes["src"] ?? "",
              ...
              nightIcon: element.querySelector("img.night-icon")?.attributes["src"] ?? "",
      ...
      print(allergyOutlook.first.allergenLink);
      //print(todaysWeatherLink?.attributes["href"] ?? "");

      //print(todaysWeather?.text.trim());
      return DetailsPageModel(
          ...
          currentWeatherIcon: "${baseUrl}${currentWeatherIcon}",
